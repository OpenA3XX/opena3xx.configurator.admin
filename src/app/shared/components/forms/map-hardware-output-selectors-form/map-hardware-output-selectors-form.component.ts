...
export class MapHardwareOutputSelectorsFormComponent {
  @Input() hardwareOutput: HardwareOutputDto | null = null;
  ...
  formConfig = computed(() => ({
    ...
    subtitle: `Map selector for: ${this.hardwareOutput?.name || 'Unknown'}`,
